...
<!-- gallery -->
    <div class="row" style=" width: 60%; margin:auto; justify-content: space-around;">

        <div class="card" style="width: 18rem; height: auto; padding: 10px;">
            <img src="images/grp.jpg" class="card-img-top" alt="...">
        </div>
        <div class="card" style="width: 18rem; height: auto; padding: 10px;">
            <img src="images/abir.jpg" class="card-img-top" alt="...">
        </div>
        <div class="card" style="width: 18rem; height: auto; padding: 10px;">
            <img src="images/grp.jpg" class="card-img-top" alt="...">
        </div>
